...
class PuzzlePolicy
{
    ...
    {
        return $user->can('view_any_puzzle');
    }
    ...
    {
        return $user->can('delete_any_puzzle');
    }
     ...
     */
    public function replicate(User $user, Puzzle $puzzle): bool
    {
